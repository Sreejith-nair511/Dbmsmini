...
import { TrendingUp, Target, Plus, CheckCircle, Circle, Calendar, Award, BarChart3, Clock, BookOpen } from "lucide-react"
...
export default function ProgressPage() {
  const { goals, setGoals, sessions, user } = useApp()
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="glass-card p-6">
        <h1 className="text-3xl font-bold text-white mb-2">{user?.name}'s Progress 📈</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card className="glass-card border-0">
          <CardContent className="p-6">
            ...
            <p className="text-blue-400 text-sm mt-2">Total study time</p>
          </CardContent>
        </Card>
          ...
          {studySessions.length > 0 ? (
            <div className="space-y-3 max-h-[400px] overflow-y-auto">
              {[...studySessions].reverse().map((session) => (
                <div key={session.id} className="p-4 rounded-lg bg-white/5 flex justify-between items-center">
                  <div>
